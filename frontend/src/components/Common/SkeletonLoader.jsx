...
export const SkeletonStats = () => (
  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
    {[1, 2, 3, 4].map((i) => (
      <div key={i} className="bg-[#16141B] rounded p-6">
...
export const SkeletonJobCard = () => (
  <div className="bg-[#16141B] rounded p-6 border border-slate-200">
    <div className="flex justify-between items-start">
      ...
      <div className="w-28 h-10 bg-slate-200 rounded-sm animate-pulse"></div>
    </div>
  </div>
);

export const SkeletonApplicationCard = () => (
  <div className="bg-[#16141B] border border-slate-200 rounded p-5">
