...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      {/* Register Card */}
      <div className="relative z-10 max-w-md w-full space-y-8 bg-white rounded-2xl shadow-2xl p-8 transform transition-all duration-500">
        <div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                name="user_type"
                className="appearance-none relative block w-full px-4 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-white"
                value={formData.user_type}
                onChange={handleChange}
              >
                <option value="candidate">👨‍💼 Candidato - Buscando oportunidades</option>
                <option value="recruiter">🏢 Recrutador - Contratando talentos</option>
              </select>
            </div>
          </div>
